...
const ICONS = {
  ...
  pulse: { d: 'M3 12h4l2.5-6 5 12 2.5-6H21' },
  ...
  pause: { d: '', fill: 'M7 5h3.5v14H7zM13.5 5H17v14h-3.5z' },
  replay: { d: 'M4.5 12a7.5 7.5 0 1 0 2.2-5.3M4.5 4.5V8H8' },
  book: { d: 'M5 4.5A1.5 1.5 0 0 1 6.5 3H19v15H6.5A1.5 1.5 0 0 0 5 19.5zM5 19.5A1.5 1.5 0 0 0 6.5 21H19' },
  bell: { d: 'M6 16v-5a6 6 0 0 1 12 0v5l1.5 2h-15zM10 21h4' },
  moon: { d: 'M19.5 14.5A7.5 7.5 0 1 1 9.5 4.5a6 6 0 0 0 10 10z' },
  flame: { d: 'M12 3c1 3.5 5 5.5 5 10a5 5 0 0 1-10 0c0-2.5 1.5-3.5 2-5 1 1.5 1.5 2.5 3 3 0-3-1-5.5 0-8z' },
  list: { d: 'M8 6h12M8 12h12M8 18h12', dots: [[4, 6], [4, 12], [4, 18]] },
  arrowUp: { d: 'M12 19V5M6 11l6-6 6 6' },
  arrowDown: { d: 'M12 5v14M6 13l6 6 6-6' },
  target: { d: '', circles: [[12, 12, 8.5], [12, 12, 2.5]] },
  search: { d: 'M16 16l4.5 4.5', circles: [[11, 11, 6.5]] },
  shield: { d: 'M12 3l8 3v6c0 4.5-3.2 8-8 9-4.8-1-8-4.5-8-9V6z' },
  download: { d: 'M12 4v11M7 11l5 5 5-5M4 20h16' },
  eyeOff: { d: 'M4 4l16 16M10.6 6.2A9 9 0 0 1 12 6c5 0 8.5 4 9.5 6-.4.8-1.3 2-2.6 3.2M6.6 7.6C4.6 9 3.3 10.9 2.5 12c1 2 4.5 6 9.5 6 1.2 0 2.3-.2 3.3-.6' },
  grip: { d: '', dots: [[9, 6], [15, 6], [9, 12], [15, 12], [9, 18], [15, 18]] },
  phone: { d: 'M11 18h2M9.5 3h5A2.5 2.5 0 0 1 17 5.5v13a2.5 2.5 0 0 1-2.5 2.5h-5A2.5 2.5 0 0 1 7 18.5v-13A2.5 2.5 0 0 1 9.5 3z' },
} as const;
