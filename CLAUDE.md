...
*(This file is identical to `AGENTS.md`. Both exist so Claude Code and Codex each
find their expected entry point. If you edit one, mirror the change to the other.)*
